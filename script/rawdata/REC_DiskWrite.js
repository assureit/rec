...
var watchID = 'REC_DiskWrite';	// RECサーバに送信するwatchID
var watchName = 'Zabbix Server Disk write statistics(sectors/sec)';	// RECサーバに送信するパラメータ説明
var itemId = '23336';	// 実際に検索時に使用するItemID
